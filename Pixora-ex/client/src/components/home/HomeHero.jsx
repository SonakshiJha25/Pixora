...
export default function HomeHero() {
  ...
  return (
    <motion.section
      ...
      className="relative grid gap-5 overflow-hidden rounded-[1.65rem] border border-pastel-cyan/40 bg-white/72 p-4 shadow-[0_28px_64px_-42px_rgba(111,203,255,0.45)] backdrop-blur-xl sm:grid-cols-[1fr_minmax(0,1.08fr)] sm:items-center sm:gap-6 sm:p-7 lg:grid-cols-[1.02fr_minmax(0,1.12fr)]"
    >
      <HeroDecorBleed />
