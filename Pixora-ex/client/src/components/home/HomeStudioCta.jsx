  ...
  return (
    <section className="relative mt-8">
      <motion.div
        ...
        className="home-section-band overflow-hidden rounded-[1.65rem] border border-pastel-cyan/35 bg-gradient-to-br from-white via-pastel-mist/90 to-[#eef6ff] p-3.5 shadow-[0_28px_64px_-40px_rgba(111,203,255,0.42)] sm:p-7"
      >
        ...
        >
          <motion.div
            className="inline-block max-w-full overflow-hidden rounded-[1.35rem] border border-pastel-cyan/25 bg-gradient-to-b from-white via-pastel-mist/80 to-[#eef7ff] p-1.5 shadow-[0_20px_48px_-24px_rgba(111,203,255,0.35)] ring-1 ring-white/90 sm:rounded-[1.5rem] sm:p-3"
          ...
          >
            <img
              ...
              className="block h-auto w-auto max-h-[min(62vh,600px)] max-w-full rounded-[1.1rem] object-contain sm:rounded-[1.25rem]"
              draggable={false}
              loading="lazy"
              decoding="async"
            />
