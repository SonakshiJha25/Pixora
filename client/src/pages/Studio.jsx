      ...
      <section className="mt-12 w-full sm:mt-16">
        <div className="studio-shell mb-5 flex flex-col gap-3 rounded-[1.5rem] p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:justify-end">
            <Link
              to="/gallery"
              className="rounded-full border border-white/[0.1] bg-white/[0.05] px-4 py-2 text-sm font-semibold text-slate-200 transition hover:border-white/18 hover:bg-white/[0.08]"
            >
              Open my gallery →
            </Link>
          </div>
